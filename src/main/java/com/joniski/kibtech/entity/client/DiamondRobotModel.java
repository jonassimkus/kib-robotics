...
public class DiamondRobotModel<T extends RobotEntity> extends HierarchicalModel<T>{
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(KibTech.MODID, "diamond_robot_entity"), "main");
